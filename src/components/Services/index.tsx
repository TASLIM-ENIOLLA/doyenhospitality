				...
				<div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20">
					<div>
						<div className="space-y-10 lg:space-y-20">
							<div className="text-3xl md:text-5xl md:line-height-lg font-semibold text-gray-700">
								We all need help to realize what we want the most
							</div>
							<div>
								<Link href="/services" className="border-blue-600 text-sm md:text-md font-semibold text-blue-600 uppercase border rounded-md tracking-wide px-5 md:px-10 py-4">
									view all services
								</Link>
							</div>
						</div>
